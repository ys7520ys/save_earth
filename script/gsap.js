...
mm.add("(max-width: 768px)",() => {
  ...
  gsap.to(".fourthSection .card:nth-of-type(1)", {
    scrollTrigger: {
      trigger: ".fourthSection .card:nth-of-type(1)",
      start: "top 80%", 
      end: "top 70%", 
      scrub: true, 
      markers: false,
  ...
  gsap.to(".fourthSection .card:nth-of-type(2)", {
    scrollTrigger: {
      trigger: ".fourthSection .card:nth-of-type(2)",
      start: "top 80%", 
      end: "top 70%", 
      scrub: true, 
      markers: false,
  ...
  gsap.to(".fourthSection .card:nth-of-type(3)", {
    scrollTrigger: {
      trigger: ".fourthSection .card:nth-of-type(3)",
      start: "top 80%", 
      end: "top 70%", 
      scrub: true, 
      markers: false,
  ...
  gsap.to(".fourthSection .card:nth-of-type(4)", {
    scrollTrigger: {
      trigger: ".fourthSection .card:nth-of-type(4)",
      start: "top 80%", 
      end: "top 70%", 
      scrub: true, 
      markers: false,
  ...
  gsap.to(".fourthSection .card:nth-of-type(5)", {
    scrollTrigger: {
      trigger: ".fourthSection .card:nth-of-type(5)",
      start: "top 80%", 
      end: "top 70%", 
      scrub: true, 
      markers: false,
  ...
  gsap.to(".fourthSection .card:nth-of-type(6)", {
    scrollTrigger: {
      trigger: ".fourthSection .card:nth-of-type(6)",
      start: "top 80%", 
      end: "top 70%", 
      scrub: true, 
      markers: false,
